...
public class Supplier : EntityBase
{
    ...
    public Supplier(string name, string address, string contact, string email, string phone, string category, bool status)
    {
        Update(name, address, contact, email, phone, category, status);
        SetCreatedDate();
    }
    ...
    public void Update(string name, string address, string contact, string email, string phone, string category, bool status)
    {
        SetName(name);
        SetAddress(address);
        SetContact(contact);
    ...
    {
        if (string.IsNullOrWhiteSpace(category)) throw new ArgumentException("Name cannot be null or empty.");
        Category = category;
    }
